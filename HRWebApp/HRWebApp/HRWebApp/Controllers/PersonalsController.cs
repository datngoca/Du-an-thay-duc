...
namespace HRWebApp.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        {
            // Tìm tất cả các bản ghi Job_History có id_employee là employeeId
            var jobHistories = db.Job_History.Where(j => j.Employee_ID == id);

            // Xóa tất cả các bản ghi Job_History tìm thấy
            db.Job_History.RemoveRange(jobHistories);
            ...
            Employment employments = db.Employments.Find(id);
            if(employments != null) { db.Employments.Remove(employments); }
